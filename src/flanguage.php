...
function DBNewLanguage($contestnumber, $param, $c = null)
{
    ...
    if (isset($param['langnumber']) && !isset($param['number'])) {
        $param['number'] = $param['langnumber'];
    }
    if (isset($param['langname']) && !isset($param['name'])) {
        $param['name'] = $param['langname'];
    }
    if (isset($param['langextension']) && !isset($param['extension'])) {
        $param['extension'] = $param['langextension'];
    }
