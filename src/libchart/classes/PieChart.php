...
class PieChart extends Chart
{
    ...
    */
    ...
    public function setPieRatio($pieRatio)
    {
    ...
    */
    ...
    public function setLabelMarginCenter($labelMarginCenter)
    {
    ...
    */
    ...
    public function outlinedBox($x1, $y1, $x2, $y2)
    {
    ...
    */
    ...
    public function drawDisc($cy, $colorArray, $mode, $shad = false)
    {
        $i = 0;
        $angle1 = 0;
        $percentTotal = 0;
