...
function DBNewAnswer($contest, $param, $c = null)
{
    ...
    if (isset($param['answernumber']) && !isset($param['number'])) {
        $param['number'] = $param['answernumber'];
    }
    if (isset($param['runanswer']) && !isset($param['name'])) {
        $param['name'] = $param['runanswer'];
    }
    if (isset($param['shortname']) && !isset($param['short'])) {
        $param['short'] = $param['shortname'];
    }
    ...
    $r = DBExec(
        $c,
        "select * from answertable as a where a.contestnumber=$contest and a.answernumber=$number for update",
