        ...
        foreach ($tags as $key => $val) {
            ...
            foreach ($val as $k => $v) {
                ...
                if (count($val) > $k + 1) {
                    ...
                    if (isset($param['usersitenumber']) && !isset($param['sitenumber'])) {
                        $param['sitenumber'] = $param['usersitenumber'];
                    }
                    if (isset($param['clarsitenumber']) && !isset($param['sitenumber'])) {
                        $param['sitenumber'] = $param['clarsitenumber'];
                    }
                    if (isset($param['runsitenumber']) && !isset($param['sitenumber'])) {
                        $param['sitenumber'] = $param['runsitenumber'];
                    }
